...
export interface ModalElementProps {
	...
	testID?: string;
	// When false, renders the modal in its surrounding Portal rather than in a
	// separate native window. This is useful for modal-like views that need to
	// be able to launch another native modal above themselves.
